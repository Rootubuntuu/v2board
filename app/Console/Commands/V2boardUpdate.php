...
class V2boardUpdate extends Command
{
     ...
     * @var string
     */
    protected $description = 'v2board renew';
    ...
    public function handle()
    {
        ...
        $this->info('After the update is complete, the queue service has been restarted, and you do not need to perform any operations.');
    }
}
